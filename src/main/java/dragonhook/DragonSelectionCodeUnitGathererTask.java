...
public class DragonSelectionCodeUnitGathererTask extends Task {

    public Boolean is_cancelled;
    public ArrayList<CodeUnit> code_units_that_are_gathered;
    ...
    public DragonSelectionCodeUnitGathererTask(String title, Program incoming_program, PluginTool tool,ProgramSelection incoming_program_selection,ArrayList<CodeUnit> incoming_selection_to_exclude) {
        super(title);
    ...
    public void run(TaskMonitor monitor) throws CancelledException {
        ...
        this.code_units_that_are_gathered=new ArrayList<CodeUnit>(); //these will be the code units in the selection
        ...
        while (address_iterator!=null && address_iterator.hasNext())
        {
            ...
            {
                code_units_that_are_gathered.add(current_code_unit); //If yes, add it to the list
            }
            if (cnt % 10000==0 || force_check_for_cancelled)
            {
                ...
                if (monitor.isCancelled())
                {
                    ...
                    monitor.cancel();
                    this.code_units_that_are_gathered=new ArrayList<CodeUnit>();
