...
public class DragonResetAllConfigsAction extends DockingAction {
    ...
    public DragonResetAllConfigsAction(DragonHookPlugin plugin) {
    ...
    private void init() {
        setPopupMenuData(
            new MenuData(new String[] { "DragonHook Config...", "Reset all config files to default" }, null,"Dragon-Hook"));
        setDescription("Reset the config files of the DragonHook plugin to their default value.");
    }
    ...
    public void actionPerformed(ActionContext context) {
        ...
        CreatorOfNecessaryFiles.resetConfigFile();
        CreatorOfNecessaryFiles.resetPythonInvokerFile();
        CreatorOfNecessaryFiles.createAllNecessaryFiles();
        ...
        cp.print_to_console("DragonHook Config Files have been reset.");
