...
public class DragonEditFridaAgentAction extends DockingAction {
	...
	public DragonEditFridaAgentAction(DragonHookPlugin plugin) {
	...
	private void init() {
		setPopupMenuData(
			new MenuData(new String[] { "DragonHook Config...", "Edit agent script..." }, null,"Dragon-Hook"));
		setDescription("Edit the agent javascript file  of the DragonHook plugin that will be fed to frida (<DefaultUserSettingsDir>/DragonHookPlugin_files/<version>/DragonHook_plugin_agent.js) using the default editor.");
	}
	...
	public void actionPerformed(ActionContext context) {
		...
		FileAndDirOpener.openFile(path_for_agent_as_str);
